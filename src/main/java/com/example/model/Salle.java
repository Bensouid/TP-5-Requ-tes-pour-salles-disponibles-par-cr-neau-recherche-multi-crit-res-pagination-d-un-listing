...
public class Salle {
    ...
    // -- Synchronisation de la relation OneToMany (Reservation)
    ...
    // -- Synchronisation de la relation ManyToMany (Equipement)
    ...
    // 4. equals et hashCode (basés sur l'ID)
    @Override
    ...
    // 5. toString (Sans les collections pour éviter les boucles infinies ou LazyInitializationException)
    @Override
